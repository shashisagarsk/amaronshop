...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            if (!user) {
                try {
                    user = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jwt$2d$decode$2f$build$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jwtDecode"])(data.token);
                } catch (e) {}
            }
            if (user && (user.id || user.email)) {
                const guestCart = JSON.parse(localStorage.getItem('cart_guest') || '[]');
                if (guestCart.length > 0) {
                    const userCartKey = "cart_".concat(user.id || user.email);
...
_s(LoginPage, "uZRSqHUj4sPtgBmpo0REalw7JVI=", false, function() {
    return [
...
//# sourceMappingURL=_c8b5aae3._.js.map